        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card border-0 shadow rounded tour-item" style="max-width: 380px; margin:auto; height: 650px;border: 1px solid #dddfe2;border-radius: 10px;">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title note-font fw-bold">Dubai - Abu Dhabi (Enjoy a buffet meal at a 5-star hotel, complimentary tickets to Burj Khalifa & ice café).</h5>
                            <p class="card-text">Tour code: <br>
                            <i class="bi bi-ticket"></i> NNSGN937-080-130923EK-D</p>
                            <p class="card-text">Place of departure: TP. Ho Chi Minh</p>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card border-0 shadow rounded tour-item" style="max-width: 380px; margin:auto; height: 650px;border: 1px solid #dddfe2;border-radius: 10px;">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title note-font fw-bold">China: Chengdu - Jiuzhaigou - Huanglong Paradise on Earth(5-star hotel stay).</h5>
                            <p class="card-text">Tour code: <br>
                            <i class="bi bi-ticket"></i> NNSGN352-019-0809233U-D</p>
                            <p class="card-text">Place of departure: TP. Ho Chi Minh</p>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <div class="card border-0 shadow rounded tour-item" style="max-width: 380px; margin:auto; height: 650px;border: 1px solid #dddfe2;border-radius: 10px;">
                        ...
                        <div class="card-body">
                            <p>13/09/2023 - 5 days</p>
                            <h5 class="card-title note-font fw-bold">China: Shanghai - Hangzhou - Suzhou - Discounted price reduced by 1,500,000 VND per person.</h5>
                            <p class="card-text">Tour code: <br>
                            <i class="bi bi-ticket"></i> NNSGN312-010-130923CZ-V</p>
                            <p class="card-text">Place of departure: TP. Ho Chi Minh</p>
