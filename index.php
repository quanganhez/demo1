  ...
  <body class="bg-light">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow rounded tour-item" style="max-width: 380px; margin:auto; height: 650px;border: 1px solid #dddfe2;border-radius: 10px;">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title note-font fw-bold">Da Lat - Dambri Waterfall - Cau Dat Tea Hill - Samten Hills Dalat - Boost tourism.</h5>
                        <p class="card-text">Tour code: <br>
                        <i class="bi bi-ticket"></i> NDSGN548-055-290823XE-V</p>
            ...
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow rounded tour-item" style="max-width: 380px; margin:auto; height: 650px;border: 1px solid #dddfe2;border-radius: 10px;">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title note-font fw-bold">Flower and Sea Journey: Dalat - Nha Trang - Vietnam National Day on September 2nd.</h5>
                        <p class="card-text">Tour code: <br>
                        <i class="bi bi-ticket"></i> NDSGN5251-062-310823XE-V</p>
                        <p class="card-text">Place of departure: TP. Ho Chi Minh</p>
            ...
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow rounded tour-item" style="max-width: 380px; margin:auto; height: 650px;border: 1px solid #dddfe2;border-radius: 10px;">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title note-font fw-bold">China: Zhangjiajie - Phoenix Ancient Town - Tianmen Mountain - Yuanjiajie | 5-star hotel, 5 days 4 nights.</h5>
                        <p class="card-text">Tour code: <br>
                        <i class="bi bi-ticket"></i> NNSGN381-031-030923VJ-H</p>
                        <p class="card-text">Place of departure: TP. Ho Chi Minh</p>
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="tour.php" class="btn btn-md btn-outline-dark rounded fw-bold shadow-none btn-lg">Show More >>></a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="facilities.php" class="btn btn-md btn-outline-dark rounded fw-bold shadow-none btn-lg">Show More >>></a>
            </div>
        </div>
    </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
                        <div class="profile-img bg-white" style="width: 50px; height: 50px; border-radius: 50%; overflow: hidden;">
                            <img src="./images/Comment/1.png"  style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <h6 class="m-0 ms-2">Random User</h6>
                    </div>
                    <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sapien purus, dictum et dictum sit amet, malesuada nec ex.
                    </p>
                </div>
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29793.988211049866!2d105.8369637!3d21.022739599999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab9bd9861ca1%3A0xe7887f7b72ca17a9!2zSMOgIE7hu5lp!5e0!3m2!1svi!2s!4v1692990327541!5m2!1svi!2s" width="700" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
